...
export default function UserDashboard() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-sky-50 to-white relative pb-16 md:pb-0 flex">
      {/* Mobile Header */}
      <header className="sticky top-0 z-50 hidden bg-white shadow-sm px-4 py-3 lg:hidden">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-[80%] sm:w-80 bg-white transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="h-full flex flex-col overflow-y-auto">
          ...
          <div className="p-6 text-center md:text-left">
            <div className="w-24 h-24 mx-auto md:mx-0 mb-4 rounded-full bg-linear-to-r from-sky-500 to-sky-600 flex items-center justify-center text-4xl font-bold text-white shadow-lg">
              {userData?.name?.[0]?.toUpperCase() || "U"}
            </div>
      ...
      <button
        className="lg:hidden fixed top-4 left-4 z-50 w-12 h-12 bg-sky-500 rounded-full shadow-2xl text-white text-2xl flex items-center justify-center"
        onClick={() => setSidebarOpen(true)}
      >
        ☰
      </button>
      ...
      <main className="flex-1 p-4 lg:p-6 overflow-y-auto bg-gray-50">
        <div className="max-w-7xl mx-auto space-y-4 lg:space-y-6">
          {/* Welcome Banner */}
          <div className="bg-linear-to-r md:mt-0 mt-16 from-sky-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Button
                      ...
                      className="h-12 w-12 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-600"
                    >
                      -
                    </Button>
                    <input
                      ...
                      onChange={(e) => setUserData({ ...userData, mealsCount: Number(e.target.value) })}
                      className="h-12 w-20 text-center border rounded-lg focus:ring-2 focus:ring-sky-500"
                    />
                    <Button
